...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    int width = 10;
    int maxR = (int) (Math.random() * 200);
    int maxG = (int) (Math.random() * 48);
    int maxB = (int) (Math.random() * 200);
    ...
    for (int w = width; w <= 50; w += 10) {
      ...
      artImage.setPixelMultiplier(1200 / w);
      ...
      try {
        ...
        ImageIO.write(image, "png",
                new File("artImages/ArtImage_" + w + "_x_" + w * 5 + "_" + timeStamp + "r-" + maxR + "_g-" + maxG + "_b-" + maxB + ".png"));
        System.out.println("Time: " + LocalDateTime.now());
      } catch (IOException e) {
